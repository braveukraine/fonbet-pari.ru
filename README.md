...
* компанія БК "ПАРИ" (сайт pari.ru) використовує технолгічну платформу компанії ФОНКОР (сайт fon.bet) 
* нижче наведені деталі повних збігів у дизайні, технологіях, зовнішніх бібліотеках та конфігураційних файлах, які використовуютья двома компаніями.
